...
!function (c) {
  ...
  o = function o() {
    ...
    o.innerHTML = i, i = null, (o = o.getElementsByTagName('svg')[0]) && (o.setAttribute('aria-hidden', 'true'), o.style.position = 'absolute', o.style.width = 0, o.style.height = 0, o.style.overflow = 'hidden', // eslint-disable-next-line no-self-assign
    o = o, (c = document.body).firstChild ? n(o, c.firstChild) : c.appendChild(o));
  }, document.addEventListener ? ~['complete', 'loaded', 'interactive'].indexOf(document.readyState) ? setTimeout(o, 0) : (_t = function t() {
    document.removeEventListener('DOMContentLoaded', _t, !1), o();
  }, document.addEventListener('DOMContentLoaded', _t, !1)) : document.attachEvent && (e = o, l = c.document, s = !1, d(), l.onreadystatechange = function () {
