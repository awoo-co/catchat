...
var HZRecorder = function HZRecorder(stream, config) {
  ...
  var interpolateArray = function interpolateArray(data, newSampleRate, oldSampleRate) {
  ...
  recorder.onaudioprocess = function (e) {
    audioData.input(e.inputBuffer.getChannelData(0)); // console.log(this.isEmptyData(e.inputBuffer.getChannelData(0)))
    // record(e.inputBuffer.getChannelData(0));
  };
};

HZRecorder.setErrorInfoText = function (errorMessage) {
...
HZRecorder.get = function (callback, config) {
  if (callback) {
    navigator.mediaDevices.getUserMedia({
      ...
      var rec = new HZRecorder(suc, config);
      callback(rec, suc);
