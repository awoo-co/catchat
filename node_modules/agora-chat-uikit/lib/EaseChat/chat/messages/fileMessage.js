...
var _ico_file = _interopRequireDefault(require("../../../common/images/ico_file.svg"));

var _img_file2x = _interopRequireDefault(require("../../../common/images/img_file@2x.png"));

var _video_file2x = _interopRequireDefault(require("../../../common/images/video_file@2x.png"));
...
function FileMessage(_ref) {
  ...
  var handleDownloadFile = function handleDownloadFile() {
    fetch(message.body.url).then(function (res) {
      ...
      (0, _download["default"])(blob, message.filename);
    })["catch"](function (err) {
      return false;
  ...
  }, !message.bySelf && /*#__PURE__*/_react["default"].createElement("img", {
  ...
  }, message.data && message.data.type ? message.data.type.includes('image') ? /*#__PURE__*/_react["default"].createElement("img", {
    src: _img_file2x["default"],
    alt: "file"
  }) : message.data.type.includes('video') ? /*#__PURE__*/_react["default"].createElement("img", {
    src: _video_file2x["default"],
    alt: "file"
  }) : /*#__PURE__*/_react["default"].createElement("img", {
    className: classes.icoFileImg,
    src: _ico_file["default"],
    alt: "file"
  }) : /*#__PURE__*/_react["default"].createElement("img", {
    className: classes.icoFileImg,
    src: _ico_file["default"],
  ...
  }, /*#__PURE__*/_react["default"].createElement("p", null, message.filename), /*#__PURE__*/_react["default"].createElement("span", null, Math.floor(message.body.size / 1024) + "kb"))), /*#__PURE__*/_react["default"].createElement("div", {
...
var _default = (0, _react.memo)(FileMessage);
